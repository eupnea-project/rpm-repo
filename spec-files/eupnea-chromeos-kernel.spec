...
Requires:    eupnea-chromeos-kernel-modules eupnea-chromeos-kernel-headers eupnea-utils >= 1.1.59
...
set -e # exit on error
# Flash the kernel
/usr/lib/eupnea/install-kernel --kernel-path /boot/vmlinuz-eupnea-chromeos
